...
class MenuMakanan extends Component {
  ...
  render() {
    return (
      <div>
        <h3>Datar Makanan Yang Kami Sediakan : </h3>
        <table>
          <tbody>
            <tr>
              <td>
              ...
              <td>
                <ListMakanan imgurl="https://www.dbs.com/iwov-resources/images/newsroom/indonesia/Blog/masakan%20nusantara/nasi%20kentut.png" />
                <center>
